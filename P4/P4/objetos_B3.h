...
typedef enum{POINTS,EDGES,SOLID,SOLID_COLORS,SOLID_PLANO,SOLID_SUAVE} _modo;  //FLAT --> CARAS    SMOOTH --> VERTICES
...
void   colors_plano(float r, float g, float b, float pos_lx, float pos_ly, float pos_lz);
//void   colors_suave(float r, float g, float b, float pos_lx, float pos_ly, float pos_lz);
...
// Materiales
_vertex4f ambiente_difuso = _vertex4f(0.9, 0.5, 0.2, 1.0);
_vertex4f especular = _vertex4f(0.5, 0.5, 0.5, 1.0);
float brillo = 110;
