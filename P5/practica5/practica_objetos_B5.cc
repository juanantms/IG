...
for (i=0;i<at_st.piezas;i++)
   {if (color[0]==at_st.color_select[i].r &&
        color[1]==at_st.color_select[i].g &&
        color[2]==at_st.color_select[i].r)
       {if (at_st.activo[i]==0) 
                      {at_st.activo[i]=1;
                      }
                  else 
